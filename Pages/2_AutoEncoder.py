...
st.set_page_config(page_title="MLP Simulation", page_icon="🦠", layout="wide")
...
st.markdown('<div class="section-title">AUTOENCODER MODEL</div>', unsafe_allow_html=True)

c_img1, c_img2, c_img3 = st.columns([1, 2, 1]) 
with c_img2:
    st.image("Assets/AutoEncoder.jpeg", 
             caption="Arsitektur AutoEncoder (Feature Extraction)", use_container_width=True)
...
if predict:
    ...
    with g2:
        ...
        st.info(f"AutoEncoder mendeteksi pola **{result_text}** setelah ekstraksi fitur.")
...
st.markdown('<div class="section-title">MLP NEURAL NETWORK</div>', unsafe_allow_html=True)
c_img1, c_img2, c_img3 = st.columns([1, 2, 1]) 
with c_img2:
    st.image("Assets/MLP.jpeg", 
             caption="Arsitektur Model MLP (Dense Layers)", use_container_width=True)
...
if predict:
    ...
    with g2:
        ...
        st.info(f"Model MLP mendeteksi pola **{result_text}** dari kombinasi parameter di atas.")